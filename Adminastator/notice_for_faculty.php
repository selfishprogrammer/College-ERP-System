        ...
        <div class="shadow-sm bg-white border" style="border-radius: 10px; margin-top: 150px; width:100%">
            ...
            <form action="<?php $_SERVER['REQUEST_URI'] ?>" class="pt-4 pr-3 pl-3" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="notice_file" class="form-control" style="border-radius: 0px 0px 0px 0px;"
                        id="">

                </div>

                <div class="form-group">
                    <button type="submit" name="notice" class="form-control btn btn-outline-success mb-2"
                        style="border-radius: 0px 0px 0px 0px;"><i>Add Notice</i></button>
                </div>
