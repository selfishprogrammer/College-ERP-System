            ...
            <form action="<?php $_SERVER['REQUEST_URI']  ?>" class="m-3 pb-2 pt-4" method="post">
                ...
                <div class="form-group">
                    <select name="subject_code" class="form-control"
                        ...
                        $subject_year = mysqli_query($conn, "select * from `subjects` where `stream`='Computer Science Engineering' and `semester`='2nd Semester'");
            ...
            <form action="<?php $_SERVER['REQUEST_URI']  ?>" class="m-3 pb-2 pt-4" method="post">
                ...
                <div class="form-group">
                    <select name="subject_code" class="form-control"
                        ...
                        $subject_year = mysqli_query($conn, "select * from `subjects` where `stream`='Electrical Engineering' and `semester`='2nd Semester'");
            ...
            <form action="<?php $_SERVER['REQUEST_URI']  ?>" class="m-3 pb-2 pt-4" method="post">
                ...
                <div class="form-group">
                    <select name="subject_code" class="form-control"
                        ...
                        $subject_year = mysqli_query($conn, "select * from `subjects` where `stream`='Electronics & Commnucation Engineering' and `semester`='2nd Semester'");
            ...
            <form action="<?php $_SERVER['REQUEST_URI']  ?>" class="m-3 pb-2 pt-4" method="post">
                ...
                <div class="form-group">
                    <select name="subject_code" class="form-control"
                        ...
                        $subject_year = mysqli_query($conn, "select * from `subjects` where `stream`='Civil Engineering' and `semester`='2nd Semester'");
            ...
            <form action="<?php $_SERVER['REQUEST_URI']  ?>" class="m-3 pb-2 pt-4" method="post">
                ...
                <div class="form-group">
                    <select name="subject_code" class="form-control"
                        ...
                        $subject_year = mysqli_query($conn, "select * from `subjects` where `stream`='Mechanical Engineering' and `semester`='2nd Semester'");
...
if (isset($_POST['cse_btn'])) {
    ...
    values ('$date','$subject','$subject_code','2nd Semester','$faculty','$time','$joining_link','Computer Science Engineering','$days')");
...
if (isset($_POST['ee_btn'])) {
    ...
    $add_cse = mysqli_query($conn, "insert into `today_class` (`date`,`subject`,`subject_code`,`semester`,`faculty`,`timiing`,`joining_link`,`stream`,`day`) 
    values ('$date','$subject','$subject_code','2nd Semester','$faculty','$time','$joining_link','Electrical Engineering','$days')");
...
if (isset($_POST['ece_btn'])) {
    ...
    $add_cse = mysqli_query($conn, "insert into `today_class` (`date`,`subject`,`subject_code`,`semester`,`faculty`,`timiing`,`joining_link`,`stream`,`day`) 
    values ('$date','$subject','$subject_code','2nd Semester','$faculty','$time','$joining_link','Electronics & Commnucation Engineering','$days')");
...
if (isset($_POST['ece_btn'])) {
    ...
    $add_cse = mysqli_query($conn, "insert into `today_class` (`date`,`subject`,`subject_code`,`semester`,`faculty`,`timiing`,`joining_link`,`stream`,`day`) 
    values ('$date','$subject','$subject_code','2nd Semester','$faculty','$time','$joining_link','Mechanical Engineering','$days')");
...
if (isset($_POST['ece_btn'])) {
    ...
    $add_cse = mysqli_query($conn, "insert into `today_class` (`date`,`subject`,`subject_code`,`semester`,`faculty`,`timiing`,`joining_link`,`stream`,`day`) 
    values ('$date','$subject','$subject_code','2nd Semester','$faculty','$time','$joining_link','Civil Engineering','$days')");
