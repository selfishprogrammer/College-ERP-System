                    ...
                    <div style="overflow-x: auto;">
                        <table class="table table-bordered">
                            ...
                            if ($day  == 'Sunday') {
                                ...
                                echo ' <p class="text-center" style="width:100%;font-family:monospace; font: size 20px;"><b>No Class For Today</b></p>';
                            } else {
                                $todays_class = mysqli_query($conn, "select * from `today_class` where `stream` = '$stream' and `semester` = '$semester' and `day` = '$day'");
